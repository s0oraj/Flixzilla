...
import blog.cosmos.home.flickzilla.activities.SeriesDetailsActivity;
...
public class SeriesCarouselAdapter extends RecyclerView.Adapter<SeriesCarouselAdapter.SeriesViewHolder> {
    ...
    public SeriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SeriesViewHolder(LayoutInflater.from(mContext).inflate(R.layout.carousel_single_item, parent, false));
    }
